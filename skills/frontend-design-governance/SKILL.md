...
1. Read these baselines before editing frontend:
   - `/Users/rlc/LingChao_Ren/1.2、数据直通车/02-开发文档/05-数据直通车-前端设计留痕与执行约束.md`
   - `/Users/rlc/LingChao_Ren/1.2、数据直通车/01-设计文档/03-知识图谱与数据地图方案.md` (for current stage boundaries)
...
4. Keep consistency after code changes:
   - If interface behavior changes, update `/Users/rlc/LingChao_Ren/1.2、数据直通车/02-开发文档/04-数据直通车-接口文档.md`.
   - If frontend decision baseline changes, update `/Users/rlc/LingChao_Ren/1.2、数据直通车/02-开发文档/05-数据直通车-前端设计留痕与执行约束.md`.

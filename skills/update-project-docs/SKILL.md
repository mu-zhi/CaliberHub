...
- Apply terminology from `/Users/rlc/LingChao_Ren/1.2、数据直通车/01-设计文档/02-统一术语表.md`.

## Full Consistency Pass

Scan all `*.md` files under:

- `/Users/rlc/LingChao_Ren/1.2、数据直通车/01-设计文档`
- `/Users/rlc/LingChao_Ren/1.2、数据直通车/02-开发文档`
- `/Users/rlc/LingChao_Ren/1.2、数据直通车/03-其他文档`

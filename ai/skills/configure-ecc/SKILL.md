---
name: configure-ecc
description: "用于引导安装和配置 Everything Claude Code 技能与规则集。"
origin: ECC
---

# ECC 配置（configure-ecc）
...
```bash
cp -r $ECC_ROOT/ai/skills/<skill-name> $TARGET/skills/
```
...
cp -r $ECC_ROOT/ai/rules/common/* $TARGET/rules/

# Language-specific rules (flat copy into rules/)
cp -r $ECC_ROOT/ai/rules/typescript/* $TARGET/rules/   # if selected
cp -r $ECC_ROOT/ai/rules/python/* $TARGET/rules/        # if selected
cp -r $ECC_ROOT/ai/rules/golang/* $TARGET/rules/        # if selected
```

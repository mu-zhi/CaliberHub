...
2. Classify changes into `docs/`、`research/`、`archive/` before editing.
3. If the document is business-facing, scenario-facing, or feature-facing, also read `docs/engineering/standards/scenario-feature-doc-standard.md` and absorb its writing style.
...
3. If a new English term, abbreviation, variable, constant, or metric is not already defined in `docs/glossary.md`, add it there before or together with the main document change.

...
description: Add or refine SpringDoc and Swagger based API documentation generation for Spring Boot services, expose OpenAPI docs, and reduce drift between implementation and interface docs.
metadata:
  author: codex
  version: "1.0.0"
...
4. If you add new annotation-driven fields or terms in docs, ensure they obey the glossary rule in `01-设计文档/02-统一术语表.md`.
